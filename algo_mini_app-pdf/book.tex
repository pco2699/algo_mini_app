...
\usepackage[dvipdfmx,bookmarks=true,bookmarksnumbered=true,colorlinks=true,%
     pdftitle={Nuxt.jsとPythonでつくるアルゴリズムミニアプリ},%
...
%%%
\title{Nuxt.jsとPythonでつくるアルゴリズムミニアプリ}
\makeatletter
\def\@subtitle{}
...
\begin{center}%
  \mbox{} \vskip5zw
   \reviewtitlefont%
    {\HUGE\bfseries Nuxt.jsとPythonでつくるアルゴリズムミニアプリ \par}%
    \vskip 1em%
...
{\noindent\reviewtitlefont\Large Nuxt.jsとPythonでつくるアルゴリズムミニアプリ} \\
\medskip
